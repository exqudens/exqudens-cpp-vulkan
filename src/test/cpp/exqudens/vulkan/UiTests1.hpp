...
namespace exqudens::vulkan {
  ...
  class UiTests1 : public testing::Test {
        ...
        public:
          ...
          void create(
            ...
            try {
              ...
              root.init(enabledExtensionNames, createSurfaceFunction, 2, width, height);
          ...
          void reCreateSwapchain(uint32_t width, uint32_t height) {
            try {
              ...
              root.initSwapchain(width, height);

              root.device.reference().waitIdle();

              camera.initSwapchain(root);
