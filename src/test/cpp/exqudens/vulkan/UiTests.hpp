        ...
        public:
          ...
          void create(
            ...
            try {
              ...
              std::cout << "root.swapchain.images.size: '" << root.swapchain.reference().getImages().size() << "'" << std::endl;
              ...
              std::ranges::for_each(data.shadowUniformBuffers, [](auto& o1) {std::cout << "data.shadowUniformBuffer: '" << (bool) o1.value << "'" << std::endl;});
