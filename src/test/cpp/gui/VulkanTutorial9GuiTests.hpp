...
class VulkanTutorial9GuiTests: public testing::Test {

    public:

        inline static const char* LOGGER_ID = "VulkanTutorial9GuiTests";
            ...
            private:
                ...
                void initVulkan() {
                    ...
                    .setCreateInfo(
                        ...
                        .setPfnUserCallback(&VulkanTutorial9GuiTests::debugCallback)
                    )
                    ...
                    .setFilterFunction(&VulkanTutorial9GuiTests::physicalDeviceFilter)
                    ...
                    EXQUDENS_LOG_INFO(LOGGER_ID) << "shaderModule: " << (shaderModule.target != nullptr);
                }
...
/*
*    @brief docs.vulkan.org/tutorial/latest/Drawing_a_triangle/Graphics_pipeline_basics/Shader_modules
*/
TEST_F(VulkanTutorial9GuiTests, test1) {
    try {
